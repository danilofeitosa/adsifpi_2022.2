        ...
        do {
            ...
            switch (opcao) {
                ...
                case "3":
                    ...
                    let idPostagem = parseInt(input("ID da Postagem: ")); //Fazer o ID ser automático
                    ...
                    let novaPostagem = new Postagem(idPostagem, textoPostagem, 0, 0, new Date(), perfildaPostagem);
