...
class Triangulo extends FiguraGeometrica {
    constructor(altura, base, lado1, lado2) {
        super();
        this._lado1 = lado1;
        this._lado2 = lado2;
        this._altura = altura;
...
class TesteFormasGeometricas {
    static testarComparacao(forma1, forma2) {
...
let quadrado2 = new Quadrado(8);
let triangulo1 = new Triangulo(6, 4, 5, 6);
let triangulo2 = new Triangulo(8, 7, 6, 6);
...
//# sourceMappingURL=exercicio09.js.map